...
#        print >>open("./chat.log","a"),pprint.pformat(event)
    ...
    def createdRoom(self, xxx_todo_changeme):
        (exchange, fullName, instance) = xxx_todo_changeme
    ...
    def messageAck(self, xxx_todo_changeme1):
        (username, message) = xxx_todo_changeme1
...
class ChatDialog(Dialog):
    ...
    def log_item( self, i ):
        """ for debugging, drill down into the event """
        if hasattr(i,"__dict__"):
            print(pprint.pformat(i.__dict__), file=open("./chat.log","a"))
        elif isinstance(i, list) or isinstance(i, tuple):
            print("[", file=open("./chat.log","a"))
            for k in i:
                self.log_item(k)
            print("]", file=open("./chat.log","a"))
        else:
            print(pprint.pformat(i), file=open("./chat.log","a"))
...
#        thread.start()
        ...
        print(str(e), file=open("./chat.log","a"))
        print(traceback.format_exc(), file=open("./chat.log","a"))
